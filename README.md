...
[![codecov](https://codecov.io/gh/jrtedeschi/fastapi/branch/main/graph/badge.svg?token=fastapi_token_here)](https://codecov.io/gh/jrtedeschi/fastapi)
[![CI](https://github.com/jrtedeschi/fastapi/actions/workflows/main.yml/badge.svg)](https://github.com/jrtedeschi/fastapi/actions/workflows/main.yml)

Awesome fastapi created by jrtedeschi

## Install

from source
```bash
git clone https://github.com/jrtedeschi/fastapi fastapi
cd fastapi
make install
```
